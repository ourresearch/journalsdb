...
Revision ID: 54a69e79acf0
Revises: 
Create Date: 2021-01-28 15:38:00.605433
...
def upgrade():
    ...
    op.create_table('open_access_publishing',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('journal_id', sa.Integer(), nullable=True),
    ...
    op.create_table('open_access_status',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('journal_id', sa.Integer(), nullable=True),
    ...
    op.create_index(op.f('ix_repositories_journal_id'), 'repositories', ['journal_id'], unique=False)
