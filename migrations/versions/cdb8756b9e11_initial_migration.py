...
Revision ID: cdb8756b9e11
Revises: 
Create Date: 2021-02-23 20:53:25.575479
...
def upgrade():
    ...
    op.create_table('issn_metadata',
    sa.Column('issn_l', sa.String(), nullable=False),
    sa.Column('issn_org_issns', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('crossref_issns', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('issn_org_raw_api', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('crossref_raw_api', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('issn_l')
    )
    op.create_index('idx_crossref_issns', 'issn_metadata', ['crossref_issns'], unique=False, postgresql_using='gin')
    op.create_index('idx_issn_org_issns', 'issn_metadata', ['issn_org_issns'], unique=False, postgresql_using='gin')
    ...
    op.create_index(op.f('ix_issn_to_issnl_issn_l'), 'issn_to_issnl', ['issn_l'], unique=False)
    op.create_table('open_access',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_open_access_issn_l'), 'open_access', ['issn_l'], unique=False)
    ...
    op.create_index(op.f('ix_repositories_issn_l'), 'repositories', ['issn_l'], unique=False)
    ...
    op.create_index(op.f('ix_countries_continent_id'), 'countries', ['continent_id'], unique=False)
    ...
    op.create_table('linked_issn_l',
    sa.Column('issn_l_primary', sa.String(), nullable=False),
    sa.Column('issn_l_secondary', sa.String(), nullable=False),
    sa.Column('reason', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['issn_l_primary'], ['issn_metadata.issn_l'], ),
    sa.ForeignKeyConstraint(['issn_l_secondary'], ['issn_metadata.issn_l'], ),
    sa.PrimaryKeyConstraint('issn_l_primary', 'issn_l_secondary')
    )
    op.create_table('mini_bundles',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.Text(), nullable=False),
    ...
    op.create_index(op.f('ix_apc_price_country_id'), 'apc_price', ['country_id'], unique=False)
    op.create_index(op.f('ix_apc_price_currency_id'), 'apc_price', ['currency_id'], unique=False)
    op.create_index(op.f('ix_apc_price_region_id'), 'apc_price', ['region_id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['imprint_id'], ['imprints.id'], ),
    sa.ForeignKeyConstraint(['issn_l'], ['issn_metadata.issn_l'], ),
    sa.ForeignKeyConstraint(['publisher_id'], ['publishers.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('issn_l'),
    sa.UniqueConstraint('uuid')
    )
    op.create_index(op.f('ix_journals_publisher_id'), 'journals', ['publisher_id'], unique=False)
    ...
    op.create_table('subscription_price',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('price', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('currency_id', sa.Integer(), nullable=False),
    sa.Column('country_id', sa.Integer(), nullable=True),
    ...
    op.create_index(op.f('ix_subscription_price_country_id'), 'subscription_price', ['country_id'], unique=False)
    op.create_index(op.f('ix_subscription_price_currency_id'), 'subscription_price', ['currency_id'], unique=False)
    op.create_index(op.f('ix_subscription_price_region_id'), 'subscription_price', ['region_id'], unique=False)
    op.create_index(op.f('ix_subscription_price_year'), 'subscription_price', ['year'], unique=False)
    op.create_table('author_permissions',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('journal_id', sa.Integer(), nullable=True),
    sa.Column('has_policy', sa.Boolean(), nullable=True),
    sa.Column('version_archivable', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('archiving_locations_allowed', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('post_print_embargo', sa.Integer(), nullable=True),
    sa.Column('licence_allowed', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_index(op.f('ix_extension_requests_journal_id'), 'extension_requests', ['journal_id'], unique=False)
    op.create_table('journal_apc_price',
    sa.Column('journal_id', sa.Integer(), nullable=False),
    sa.Column('apc_price_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['apc_price_id'], ['apc_price.id'], ),
    sa.ForeignKeyConstraint(['journal_id'], ['journals.id'], ),
    sa.PrimaryKeyConstraint('journal_id', 'apc_price_id')
    )
    op.create_table('journal_metadata',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('journal_id', sa.Integer(), nullable=False),
    ...
    op.create_table('journal_mini_bundle_price',
    sa.Column('mini_bundle_id', sa.Integer(), nullable=False),
    sa.Column('subscription_price_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['mini_bundle_id'], ['mini_bundles.id'], ),
    sa.ForeignKeyConstraint(['subscription_price_id'], ['subscription_price.id'], ),
    sa.PrimaryKeyConstraint('mini_bundle_id', 'subscription_price_id')
    )
    op.create_table('journal_subjects',
    sa.Column('journal_id', sa.Integer(), nullable=False),
    ...
    op.create_table('journal_subscription_price',
    sa.Column('journal_id', sa.Integer(), nullable=False),
    sa.Column('subscription_price_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['journal_id'], ['journals.id'], ),
    sa.ForeignKeyConstraint(['subscription_price_id'], ['subscription_price.id'], ),
    ...
    op.create_table('mini_bundle_journals',
    sa.Column('mini_bundle_id', sa.Integer(), nullable=False),
    sa.Column('journal_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['journal_id'], ['journals.id'], ),
    sa.ForeignKeyConstraint(['mini_bundle_id'], ['mini_bundles.id'], ),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_extension_requests_journal_id'), table_name='extension_requests')
    ...
    op.drop_index(op.f('ix_subscription_price_region_id'), table_name='subscription_price')
    op.drop_index(op.f('ix_subscription_price_currency_id'), table_name='subscription_price')
    op.drop_index(op.f('ix_subscription_price_country_id'), table_name='subscription_price')
